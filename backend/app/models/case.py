...
class ClinicalCase(Base):
    ...
    ai_differential: Mapped[Optional[str]] = mapped_column(String(1000), nullable=True)
    ...
    interim_advice: Mapped[Optional[str]] = mapped_column(String(1000), nullable=True)
    doctor_notes: Mapped[Optional[str]] = mapped_column(String(1000), nullable=True)
    prescription: Mapped[Optional[str]] = mapped_column(String(1000), nullable=True)
