...
Plans:
- [ ] 13-01: Firebase project configuration, backend Firebase Admin SDK integration, and signed URL generation service.
- [ ] 13-02: Mobile Firebase Storage upload client, two-phase sync queue integration, and media preview verification.
...
Plans:
- [ ] 14-01: Cloud PostgreSQL + PostGIS database connection, migration verification, and Redis pub/sub cluster streaming.
- [ ] 14-02: Firebase Cloud Messaging (FCM) / SMS push alert integration and Web-GIS live alert banner integration.
