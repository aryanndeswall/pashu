    ...
    if (!ok && !otpError) {
      setLocalError(
        currentLanguage === 'en'
          ...
          : currentLanguage === 'hi'
          ? 'सत्यापन असफल। डेमो OTP 123456 उपयोग करें।'
    ...
    <div className="max-w-md mx-auto p-4 space-y-5 animate-in fade-in duration-200">
        ...
        <p className="text-xs text-slate-600 dark:text-slate-400">
          <span>
            {currentLanguage === 'en'
              ? 'Code sent to: '
              : currentLanguage === 'hi'
              ? 'इस नंबर पर भेजा गया कोड: '
              : 'या क्रमांकावर पाठवलेला कोड: '}
          </span>
      ...
      <form onSubmit={handleVerify} className="space-y-5">
        ...
        >
          ...
          <span>
            {currentLanguage === 'en'
              ? '⚡ SIH Demo: Auto-Fill OTP (123456)'
              : currentLanguage === 'hi'
              ? '⚡ SIH Demo: ओटीपी स्वतः भरें (123456)'
              : '⚡ SIH Demo: Auto-Fill OTP (123456)'}
          </span>
        </button>
          ...
          {otpCountdown > 0 ? (
            <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
              {currentLanguage === 'en'
                ...
                : currentLanguage === 'hi'
                ? `पुनः ओटीपी भेजें: ${otpCountdown} सेकंड`
              ...
              <span>
                {t(
                  ...
                  currentLanguage === 'en'
                    ? 'Resend OTP'
                    : currentLanguage === 'hi'
                    ? 'पुनः ओटीपी भेजें (Resend OTP)'
                    : 'पुन्हा ओटीपी पाठवा (Resend OTP)'
                )}
              </span>
            </button>
          )}
            ...
            {isVerifying
              ...
              : t(
                  ...
                  currentLanguage === 'en'
                    ? 'Verify & Continue'
                    : currentLanguage === 'hi'
                    ? 'सत्यापित करें व आगे बढ़ें (Verify & Continue)'
